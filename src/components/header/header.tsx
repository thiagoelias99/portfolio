...
export default function Header({ setLang }: HeaderProps) {
  return (
    <header
      className='fixed px-4 top-0 left-0 right-0 w-screen h-16 bg-gray-800 text-white flex items-center justify-between'
    >
      <h1 className='text-xl font-bold'>Thiago Elias</h1>
